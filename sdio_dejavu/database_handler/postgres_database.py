...
class PostgreSQLDatabase(CommonDatabase):
    ...
    CREATE_FINGERPRINTS_TABLE_INDEX_HASH64 = f"""CREATE INDEX IF NOT EXISTS  "ix_{FINGERPRINTS_TABLENAME}_{FIELD_HASH64}" ON "{FINGERPRINTS_TABLENAME}" ("{FIELD_HASH64}");"""

    CREATE_FINGERPRINTS_TABLE_INDEX_SONGID = f"""CREATE INDEX IF NOT EXISTS  "ix_{FINGERPRINTS_TABLENAME}_{FIELD_SONG_ID}" ON "{FINGERPRINTS_TABLENAME}" ("{FIELD_SONG_ID}");"""

    CREATE_FINGERPRINTS_TABLE_INDEX = f"""
        CREATE INDEX "ix_{FINGERPRINTS_TABLENAME}_{FIELD_HASH64}" ON "{FINGERPRINTS_TABLENAME}"
        USING hash ("{FIELD_HASH64}");
    """
